...
- [x] WCAG コントラスト要件の遵守（4.5:1 以上）
- [x] キーボードナビゲーション対応
- [x] 適切な aria 属性設定
- [x] フォーカスインジケーターの視認性（3:1 以上）
- [x] 最小タッチターゲット 44px 確保
- [x] スクリーンリーダー対応のテキスト

### 必須項目（デザイン）

- [x] グレースケールの使用（真っ黒・真っ白の適切な使用）
- [x] 8px ベースの余白システム
- [x] 角丸の一貫性（lg, xl, 2xl, 3xl）
- [x] 全インタラクティブ要素への影付与
- [x] スムーズなトランジション（200ms 以下）
- [x] ボタンテキストは font-semibold 以上
- [x] 白背景の青テキストは blue-700 以上
- [x] カードには明確な境界線（border-gray-300）
